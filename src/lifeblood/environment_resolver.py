...
class StandardEnvironmentResolver(BaseEnvironmentResolver):
    ...
    @classmethod
    def autodetect_software(cls) -> dict:
        import pathlib
        import sys
        import re
        """
        ...
        if sys.platform.startswith('linux'):
            base = pathlib.Path(r'/opt')
            hfs_prefix = pathlib.Path('')
        elif sys.platform.startswith('win'):
            base = pathlib.Path(r'C:\Program Files\Side Effects Software')
            hfs_prefix = pathlib.Path('')
        elif sys.platform.startswith('darwin'):
            base = pathlib.Path(r'/Applications/Houdini')
